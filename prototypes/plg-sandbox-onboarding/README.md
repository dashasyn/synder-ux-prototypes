...
Open `index.html` and use the dark top bar to switch **Survey → Success → App**, try Sync mode and Checklist **Current | Hybrid** on the App view, and **Reset** to clear survey state.
